...
\textbf{Make sure that completeness is assigned based on the bias-corrected size and SB.}


\subsection{Modeling and measurement error}\label{sec:modeling}
...
the \citet{Schlafly:2011aa} recalibration of the \citet{Schlegel:1998aa} dust maps. 
}
\end{table}
